 ...
 **Natural** is the broader agentic money stack. **Frames** and **Sponge** are spend/control surfaces. **claw.credit** is credit execution. These can consume a back-end credit+servicing layer when routed revenue exists.
