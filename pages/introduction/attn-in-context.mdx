...
It compares firms on two commercial axes: **underwriting basis** (`live revenue / receivables` vs `borrower reputation / balance sheet`) and **repayment enforceability** (`reputation / unsecured` vs `cash-flow captured / programmable`).
